...
class AllPlatformTests(BasePlatformTests):
    ...
    def test_forcefallback(self):
        testdir = os.path.join(self.unit_test_dir, '32 forcefallback')
    ...
    def test_testsetup_selection(self):
        testdir = os.path.join(self.unit_test_dir, '15 testsetup selection')
        self.init(testdir)
        self.build()
...
''')
    ...
    def test_prebuilt_object(self):
        ...
        tdir = os.path.join(self.unit_test_dir, '16 prebuilt object')
    ...
    def test_prebuilt_static_lib(self):
        ...
        tdir = os.path.join(self.unit_test_dir, '17 prebuilt static')
    ...
    def test_prebuilt_shared_lib(self):
        ...
        tdir = os.path.join(self.unit_test_dir, '18 prebuilt shared')
    ...
    def test_pkgconfig_static(self):
        ...
        testdir = os.path.join(self.unit_test_dir, '19 pkgconfig static')
    ...
    def test_array_option_change(self):
        ...
        tdir = os.path.join(self.unit_test_dir, '20 array option')
        self.init(tdir)
        original = get_opt()
    ...
    def test_warning_location(self):
        tdir = os.path.join(self.unit_test_dir, '23 warning location')
        out = self.init(tdir)
        for expected in [
    ...
    def test_permitted_method_kwargs(self):
        tdir = os.path.join(self.unit_test_dir, '26 non-permitted kwargs')
        out = self.init(tdir)
        for expected in [
    ...
    def test_compiler_run_command(self):
        ...
        run_command().
        '''
        testdir = os.path.join(self.unit_test_dir, '25 compiler run_command')
        self.init(testdir)
    ...
    def test_check_module_linking(self):
        ...
        """
        tdir = os.path.join(self.unit_test_dir, '31 shared_mod linking')
        out = self.init(tdir)
...
recommended as it is not supported on some platforms''')
    ...
    def test_ndebug_if_release_disabled(self):
        testdir = os.path.join(self.unit_test_dir, '29 ndebug if-release')
    ...
    def test_guessed_linker_dependencies(self):
        ...
        '''
        # build library
        testdirbase = os.path.join(self.unit_test_dir, '30 guessed linker dependencies')
    ...
    def test_command_line(self):
        testdir = os.path.join(self.unit_test_dir, '35 command line')
...
class FailureTests(BasePlatformTests):
    ...
    def test_subproject_variables(self):
        ...
        '''
        tdir = os.path.join(self.unit_test_dir, '21 subproj dep variables')
    ...
    def test_exception_exit_status(self):
        ...
        '''
        tdir = os.path.join(self.unit_test_dir, '22 exit status')
...
class LinuxlikeTests(BasePlatformTests):
    ...
    def test_pkg_unfound(self):
        testdir = os.path.join(self.unit_test_dir, '24 unfound pkgconfig')
        self.init(testdir)
    ...
    def test_install_umask(self):
        ...
        orig_testdir = os.path.join(self.unit_test_dir, '27 install umask')
        # Create a new testdir under tmpdir.
        tmpdir = os.path.realpath(tempfile.mkdtemp())
        self.addCleanup(windows_proof_rmtree, tmpdir)
        testdir = os.path.join(tmpdir, '27 install umask')
...
'''.format(os.path.join(testdir, 'some_cross_tool.py')))
    ...
    def test_reconfigure(self):
        testdir = os.path.join(self.unit_test_dir, '14 reconfigure')
    ...
    def test_pkgconfig_usage(self):
        testdir1 = os.path.join(self.unit_test_dir, '28 pkgconfig usage/dependency')
        testdir2 = os.path.join(self.unit_test_dir, '28 pkgconfig usage/dependee')
    ...
    def test_pkgconfig_internal_libraries(self):
        ...
        with tempfile.TemporaryDirectory() as tempdirname:
            # build library
            testdirbase = os.path.join(self.unit_test_dir, '33 pkgconfig use libraries')
            testdirlib = os.path.join(testdirbase, 'lib')
    ...
    def test_deterministic_dep_order(self):
        ...
        '''
        testdir = os.path.join(self.common_test_dir, '204 dep order')
        self.init(testdir)
...
class LinuxArmCrossCompileTests(BasePlatformTests):
    ...
    def test_cross_file_overrides_always_args(self):
        ...
        '''
        testdir = os.path.join(self.unit_test_dir, '34 cross file overrides always args')
